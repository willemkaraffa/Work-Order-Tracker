...
const DEFAULT_TYPES = ['HVAC', 'Plumbing', 'Other'];
...
// Legacy backfill removed (change11). Migration strips the flag from stored data.
...
const LOCKED_STATUSES = new Set(['Cancelled', 'Complete - Pending Approval']);
...
const SYSTEM_TAGS = ['schedule', 'onsite', 'visited', 'offmap'];
const SYSTEM_TAG_LABELS = {
...
function isCompletionStatusName(s) {
  if (!s) return false;
...
const DEFAULT_MORE_INFO_COLOR = '#d97706';
...
// HVAC marker.
const DEFAULT_MAP_MARKER_COLORS = {
...
function InlineEdit({ value, onCommit, onCancel, style, title }) {
...
function Seg({ options, value, onChange, equal }) {
  return (
    <div style={{
