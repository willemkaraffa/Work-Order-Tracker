...
SPEND
  heavy-verify runs observed: 7   scope: plan plan-2026-09-08-admin-s5-slice-j4-wo-listing-and
  OVER the plan budget of 2 by 5. Verify proportional to risk.
  Counts RUNS the PostToolUse hook saw, not tokens. A floor, never a bill.
  spawns this session: 1   (counted from agent meta files, not from a counter)

COST (tokens, derived from the transcripts; informational, not a gate)
  73 session(s), 12050 calls, 2.26B tokens, 89 spawn(s) all-time.
  a spawn here costs 18.8k before it reads anything (89 sample(s)); 1 file(s) estimates 279.8k.
  Derived from the transcripts on every run. Tokens, not dollars. No cache, no ledger file.

FINDINGS
  ledger: 164 finding(s), diff 0cc73909e5562ae9
