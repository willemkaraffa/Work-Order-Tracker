...
=== PLAN ===
[attachment 2: .plan.json @ plan-2026-09-15-intent-record-merge-main-into-fe -- 3792 bytes, not copied]
```
...
[
  ...
  {"id": "item-5", "quote": "Run exactly: npm install github:willemkaraffa/Project-Overseer#294bac8. No other package.json edits. Confirm observation L1-po-pinned-294bac8 (dependency ends with #294bac8 and lock packages['node_modules/project-overseer'].resolved ends with #294bac8dabd1c4296f28e7a0fe079e83caff2232)."},
  {"id": "item-6", "quote": "HISTORY.md gains this merge's line; NEXT-STEPS.md is updated; this record, its approval and the merge's methodology records are staged."},
  ...
  {"id": "obs-L1-po-pinned-294bac8", "quote": "Confirm observation L1-po-pinned-294bac8 (dependency ends with #294bac8 and lock packages['node_modules/project-overseer'].resolved ends with #294bac8dabd1c4296f28e7a0fe079e83caff2232)."},
  {"id": "obs-C1-no-conflict-markers", "quote": "observation C1-no-conflict-markers"},
  {"id": "obs-A1-amh-one-refill", "quote": "observation A1-amh-one-refill"},
  {"id": "obs-A2-amh-parses", "quote": "observation A2-amh-parses"},
  {"id": "obs-M1-msr-open-tab-scan", "quote": "observation M1-msr-open-tab-scan"},
  {"id": "obs-M2-msr-alarm-and-bail", "quote": "observation M2-msr-alarm-and-bail"},
  {"id": "obs-T1-smoke-test", "quote": "node test/renderer-smoke.test.js"},
  {"id": "obs-ST1-status-enforcing", "quote": "node node_modules/project-overseer/scripts/overseer-status.js"},
  {"id": "obs-I1-suite-stays-green", "quote": "node test/run.js"}
]
```
